...
client_creds_b64 = base64.b64encode(client_creds.encode()) # base64.b64decode(client_creds_b64)
...
class SpotifyAPI(object):
  ...
  client_secret = None
  token_url = 'https://accounts.spotify.com/api/token'
  search_endpoint = 'https://api.spotify.com/'
  version = 'v1'
  ...
  def base_search(self, query_params):
    ...
    endpoint = f'{self.search_endpoint}{self.version}/search'
  ...
  def get_resource(self, lookup_id, resource_type='albums'):
    endpoint = f'{self.search_endpoint}{self.version}/{resource_type}/{lookup_id}/'
    headers = self.get_resource_header()
